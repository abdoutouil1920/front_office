...
export class AddProductComponent implements OnInit {
  ...
  addNewProduct() {
    const admintoken: string | null = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NjMwMGRiZWE1NWQ1ODMwYzYyZjFhNWYiLCJyb2xlIjoiQWRtaW4iLCJpYXQiOjE3MTU3OTUzNDUsImV4cCI6MTcxNTg4MTc0NX0.xmIrjgyO3JrqHOa_-qPhIic3gX3EXUs8hFBubIIWHPo';
    ...
    if (this.productForm.valid && admintoken) {
      ...
      formData.append('image', this.image as File); // Append actual file, not form control value
      formData.append('images', this.images[0] as File); // Assuming you want to upload only the first image
